...
class ChartColors {
  ...
  static const Color gridColor = Color(0x264c5c74);
  ...
  static const Color maxMinTextColor = Color(0xff2196F3); //最大最小值的颜色
  ...
  static const Color realTimeTextBorderColor = Color(0xff2196F3);
  static const Color realTimeTextColor = Color(0xff2196F3);

  //实时线
  static const Color realTimeLineColor = Color(0xff2196F3);
...
class ChartStyle {
  ...
  static const double topPadding = 30.0, bottomDateHigh = 16.0, childPadding = 25.0;
